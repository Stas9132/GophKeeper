...
type KeeperClient interface {
	...
	Put(ctx context.Context, opts ...grpc.CallOption) (Keeper_PutClient, error)
	Get(ctx context.Context, in *ObjMain, opts ...grpc.CallOption) (*ObjMain, error)
}
...
func (c *keeperClient) Put(ctx context.Context, opts ...grpc.CallOption) (Keeper_PutClient, error) {
	stream, err := c.cc.NewStream(ctx, &Keeper_ServiceDesc.Streams[0], "/keeper.keeper/Put", opts...)
	if err != nil {
		return nil, err
	}
	x := &keeperPutClient{stream}
	return x, nil
}

type Keeper_PutClient interface {
	Send(*ObjMain) error
	CloseAndRecv() (*Empty, error)
	grpc.ClientStream
}

type keeperPutClient struct {
	grpc.ClientStream
}

func (x *keeperPutClient) Send(m *ObjMain) error {
	return x.ClientStream.SendMsg(m)
}

func (x *keeperPutClient) CloseAndRecv() (*Empty, error) {
...
func (c *keeperClient) Get(ctx context.Context, in *ObjMain, opts ...grpc.CallOption) (*ObjMain, error) {
	out := new(ObjMain)
	err := c.cc.Invoke(ctx, "/keeper.keeper/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeeperServer interface {
	...
	Put(Keeper_PutServer) error
	Get(context.Context, *ObjMain) (*ObjMain, error)
...
func (UnimplementedKeeperServer) Put(Keeper_PutServer) error {
	return status.Errorf(codes.Unimplemented, "method Put not implemented")
}
func (UnimplementedKeeperServer) Get(context.Context, *ObjMain) (*ObjMain, error) {
...
func _Keeper_Put_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(KeeperServer).Put(&keeperPutServer{stream})
}

type Keeper_PutServer interface {
	SendAndClose(*Empty) error
	Recv() (*ObjMain, error)
	grpc.ServerStream
}

type keeperPutServer struct {
	grpc.ServerStream
}

func (x *keeperPutServer) SendAndClose(m *Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *keeperPutServer) Recv() (*ObjMain, error) {
	m := new(ObjMain)
...
func _Keeper_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/keeper.keeper/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeeperServer).Get(ctx, req.(*ObjMain))
	}
	return interceptor(ctx, in, info, handler)
}
